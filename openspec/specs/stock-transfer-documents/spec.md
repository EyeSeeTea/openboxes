...
> Capability: attach documents to a stock transfer, optionally enforce
> attachment before completion based on per-location and per-bin activity
> codes, with idempotent retries and fail-closed UX.
>
> Source change: `openspec/changes/archive/2026-04-29-stock-transfer-document-upload/`
