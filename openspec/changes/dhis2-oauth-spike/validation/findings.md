...
Source: cpr-test.samaritanspurse.org (DHIS2 2.x), OpenBoxes codebase, Gradle dependency tree.
...
- **DHIS2 UIDs are stable 11-char identifiers** → Confirmed: `SyI5Bx6M0Iv`. Impact: dhis2-oauth-core D2 — match-by-UID strategy is sound.
