## DHIS2 OAuth2 Client Registration — cpr-test.samaritanspurse.org (2.x)
...
Verified on cpr-test.samaritanspurse.org — client `openboxes-spike` (uid
`UocRZtLS0Do`) was created via API and verified functional.
