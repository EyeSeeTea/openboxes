...
No upstream Groovy/Java source files (controllers, services, domain classes) are modified. No upstream Liquibase changesets are edited. The `resources.groovy` edit is a bean override, not a code change to the upstream service itself.
